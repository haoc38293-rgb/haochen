...
export default function Home(){
  ...
  return <main onClick={capture}>
    ...
    <footer><span>语境 · 让词汇有故事</span><span>高中闪过3500：高频 → 中频 → 低频</span></footer>{toast&&<div className="toast" role="status">✓ {toast}</div>}
  </main>;
}
